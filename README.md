...
Press `Cmd+Shift+Space` to open a Spotlight-style terminal window. Pick a tool — Claude Code, Gemini, Copilot, Ollama, Codex, or anything else — and start working. Each tool runs in its own PTY-backed terminal with full color, scrollback, and keyboard support
